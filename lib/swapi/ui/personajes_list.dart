    ...
    return Scaffold(
      ...
      body: StreamBuilder(
        ...
        builder: (context, AsyncSnapshot<ModelPersonaje> snapshot) {
          ...
          return Center(child: CircularProgressIndicator(backgroundColor: AppTheme.mainColor1,));
        },
      ),
    );
  }
  ...
  Widget buildList(AsyncSnapshot<ModelPersonaje> snapshot) {
    return GridView.builder(
        ...
        itemBuilder: (BuildContext context, int index) {
          return _listPersonajes(index, context, snapshot);
         
        });
  }

  _listPersonajes(int index, BuildContext context, AsyncSnapshot<ModelPersonaje> snapshot) {
